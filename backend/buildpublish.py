...
def restart_pm2(domain: str = None):
    ...
    Args:
        domain: Domain name (PM2 app name is {domain}-backend per infrastructure_manager.py)
                Template uses ai-powered-ecommerce-platform-3p7ork placeholder, replaced by infra manager during provisioning
    """
    print("\n" + "="*50)
    print("PM2 RESTART")
    print("="*50)
    ...
    if not domain:
        domain = "ai-powered-ecommerce-platform-3p7ork"
