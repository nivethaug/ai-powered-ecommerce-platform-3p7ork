...
def restart_pm2(project_name: str = None):
    ...
    Args:
        project_name: Project name (uses ai-powered-ecommerce-platform-3p7ork placeholder by default)
    """
    print("\n" + "="*50)
    print("PM2 RESTART")
    print("="*50)
    ...
    if not project_name:
        project_name = "ai-powered-ecommerce-platform-3p7ork"
    
    return run(f"pm2 restart ai-powered-ecommerce-platform-3p7ork-frontend")
...
def main():
    ...
    if not args.no_restart and success:
        restart_pm2()  # Uses ai-powered-ecommerce-platform-3p7ork placeholder
        reload_nginx()
